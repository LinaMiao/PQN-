function [x,i,f,g,r,funEvals,xNorm1part,rNorm2part,timePqnProject,projects] = minConF_PQN(funObj,x,funProj,options,itn,weights)
...
[verbose,numDiff,optTol,maxIter,maxProject,suffDec,corrections,adjustStep,bbInit,SPGoptTol,SPGiters,SPGtestOpt] = ...
    ...
    'corrections',20,'adjustStep',0,'bbInit',1,'SPGoptTol',1e-6,'SPGiters',500,'SPGtestOpt',1);
