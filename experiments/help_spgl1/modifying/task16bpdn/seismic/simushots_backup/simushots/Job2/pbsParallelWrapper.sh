...
# qsub -h  -l nodes=1:ppn=1+4:ppn=4,pmem=3999999kb,walltime=48:00:00 -q matwork -o "/users/slic/linamiao/Dropbox/PQN/experiments/help_spgl1/modifying/task16bpdn/seismic/simushots/Job2/Job2.log" -N Job2 "/users/slic/linamiao/Dropbox/PQN/experiments/help_spgl1/modifying/task16bpdn/seismic/simushots/Job2/pbsParallelWrapper.sh" 
