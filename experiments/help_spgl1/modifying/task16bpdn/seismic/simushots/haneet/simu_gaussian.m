...
%% set rand seed for reproducible purpose
...
% Run spgl1
t = cputime;
[xest,r_spg,g_spg,info_spg] = spgl1(A,simD,0,0,[],options);
tspg = cputime - t;
...
t = cputime;
[xest,r_pqn1,g_pqn1,info_pqn1] = pqnl1_2(A,simD,0,0,zeros(size(A,2),1),options,sigma_ref);
tpqn = cputime -t ;
% Transform back to physical domain
Dest = C'*xest;
