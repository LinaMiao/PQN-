...
%            fprintf('Directional Derivative below optTol\n');
    ...
    %%%%%%%%%%%%%%%%%spglincurvy from spgl1%%%%%%%%%%%%%%%%%%%%%%%%%%
    lineSrchIt = 100;
    f_old = f;
    if itnpqn == 0
        [~,t,x,f,g,r,lnErr,Evals] = spgLineCurvy(x,g,f_old,funObj,funProj,lineSrchIt);
    else
        [~,t,x,f,g,r,lnErr,Evals] = pqnLineCurvy(x,d,f_old,funObj,funProj,lineSrchIt);
    end
    funEvals = funEvals + Evals;
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    if lnErr == 0 1; % lineCurvy successed
    else % lineCurvy failed,take step back and do a normal line search
    x = x_old; g = g_old; r = .5*f^2;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    g = g_new;
    r = r_new;
    end % end of whether spgLineCurvy failed or not
