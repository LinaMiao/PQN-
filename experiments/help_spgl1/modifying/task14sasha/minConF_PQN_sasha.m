function [x,itnpqn,f,g,r,xNorm1part,rNorm2part,timePqnProject,testUpdateTau] = minConF_PQN_2(funObj,x,funProj,options,itn,maxitn,weights,decTol,sigma,b,tau,bpTol)
% 
...
%      end
    ...
    aError1 = rNorm - sigma;
    aError2 = f - sigma^2; %%% Lina :: adjust acoording to sasha
