function [x,itnpqn,f,g,r,xNorm1part,rNorm2part,timePqnProject,testUpdateTau,nLineTot] = minConF_PQN_pqnl1(funObj,x,funProj,options,itn,maxitn,weights,decTol,sigma,b,tau,bpTol)
% 
...
%         end
        ...
        if testUpdateTau
            fprintf('break of testUpdateTau, exit minConf_PQN\n');
