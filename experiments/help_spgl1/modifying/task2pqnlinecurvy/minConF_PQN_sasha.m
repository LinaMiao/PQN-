function [x,itnpqn,f,g,r,xNorm1part,rNorm2part,timePqnProject,testUpdateTau,nLineTot] = minConF_PQN_sasha(funObj,x,funProj,options,itn,maxitn,weights,decTol,sigma,b,tau,bpTol)
% 
...
[verbose,numDiff,optTol,maxIter,maxProject,suffDec,corrections,adjustStep,bbInit,SPGoptTol,SPGiters,SPGtestOpt] = ...
    ...
    'corrections',inf,'adjustStep',1,'bbInit',1,'SPGoptTol',1e-6,'SPGiters',500,'SPGtestOpt',1);
...
while funEvals <= maxIter
   ...
   % Backtracking Line Search
    ...
    aError1 = rNorm - sigma;
    aError2 = f - sigma; %%% Lina :: adjust acoording to sasha
