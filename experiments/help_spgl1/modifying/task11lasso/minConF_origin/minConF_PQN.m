function [x,itnpqn,f,g,r,xNorm1part,rNorm2part,timePqnProject,testUpdateTau,nLineTot] = minConf_PQN(funObj,x,funProj,options,itn,maxitn,weights,decTol,sigma,b,tau,bpTol)
