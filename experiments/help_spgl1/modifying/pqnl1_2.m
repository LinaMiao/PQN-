function [x,r,g,info] = pqnl1_2( A, b, tau, sigma, x, options )
%
...
while 1
    ...
    if  1
        try
            ...
            opt.maxIter = 2; % how many itn pqn going to run, ie maxIter-1 is the correction we had in Hessian
            ...
            [x,iterpqn,f,g,r,~,xNorm1part,rNorm2part,timePqnProject,~,S,Y,g_old,x_old,Hdiag,testUpdateTau] = ...
                minConF_PQN_2(funObj,xOld,funProj,opt,iter,options.iterations,weights,decTol,sigma,b,tau,bpTol,S,Y,g_old,x_old,Hdiag);
            temp = norm(r);
            % testUpdateTau = 1;
            if iterpqn<=0 1;
            else
