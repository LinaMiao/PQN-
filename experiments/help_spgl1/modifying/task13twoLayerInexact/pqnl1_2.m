function [x,r,g,info] = pqnl1_2( A, b, tau, sigma, x, options,flag )
%
...
while 1
    ...
    try
        ...
        [x,iterpqn,f,g,r,xNorm1part,rNorm2part,timePqnProject,testUpdateTau,nLine] = ...
            minConF_PQN_pqnl1(funObj,xOld,funProj,opt,iter,options.iterations,weights,decTol,sigma,b,tau,bpTol,flag);
