...
model.nshot       = 5;% number of shot positions
...
%% inversion
% opts.iterations = 20;
% [results1] = MGNFWI(reshape(m0,n),Dobs,wavelet,model,opts,1);
% opts.iterations = 20;
% [results2] = MGNFWI(reshape(m0,n),Dobs,wavelet,model,opts,2);
% save res results1 results2
...
save camenbert m0 n Dobs wavelet model opts
% %% inversion
% opts.iterations = 20;
