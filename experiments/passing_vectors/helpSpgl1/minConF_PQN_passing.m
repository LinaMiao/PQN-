function [x,itnpqn,f,g,r,funEvals,xNorm1part,rNorm2part,timePqnProject,projects,S,Y,g_old,x_old,Hdiag] = minConF_PQN_passing(funObj,x,funProj,options,itn,maxitn,weights,decTol,sigma,b,tau,bpTol,S,Y,g_old,x_old,Hdiag)
...
%                 S = S(:,end-floor(temp/2):end);
%                 Y = Y(:,end-floor(temp/2):end);
