function [x,itnpqn,f,g,r,funEvals,xNorm1part,rNorm2part,timePqnProject,projects,S,Y,g_old,x_old,Hdiag] = minConF_PQN_3(funObj,x,funProj,options,itn,maxitn,weights,decTol,sigma,b,tau,bpTol,S,Y,g_old,x_old,Hdiag)



% this version only put minConF_PQN insised spgl1, 
% with passing of Hessian vectors
% with all the exit of PQN kept

% with another spg optimal criterior
...
%                 S = S;
%                 Y = Y;
                %Hdiag = Hdiag(:,end-floor(temp/2):end); Hdiag is a single
