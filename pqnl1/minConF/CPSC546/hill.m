...
if 1,
    for iscale=1:nscale
        ...
        for imatvec = 1:nmatvec
            ...
            [xhatpqn,r,~,infopqn{imatvec,iscale}] = pqnl1(A, b, 0, 1e-2, zeros(size(A,2),1), opt);
    ...
    save hill errorspg errorpqn N delta rho matrixvectors infospg infopqn %infoamp
else
    load hill
end
%
...
%%
figure;plot(squeeze(imatvec),squeeze(errorspg(:,:,4))./squeeze(errorspg(:,:,5)),'-','LineWidth',2);title('SPGl1')
ylabel('error');xlabel('maxvec');%legend(num2str(matrixvectors(1)),num2str(matrixvectors(2)),num2str(matrixvectors(3)))%,num2str(iterations(4)),num2str(iterations(5)),num2str(iterations(6)),num2str(iterations(7)),num2str(iterations(8)),num2str(iterations(9)),num2str(iterations(10)))
axis tight
figure;plot(squeeze(imatvec),squeeze(errorpqn(:,:,4))./squeeze(errorpqn(:,:,5)),'-','LineWidth',2);title('pqnl1')
ylabel('error');xlabel('maxvec');%legend(num2str(matrixvectors(1)),num2str(matrixvectors(2)),num2str(matrixvectors(3)))%,num2str(iterations(4)),num2str(iterations(5)),num2str(iterations(6)),num2str(iterations(7)),num2str(iterations(8)),num2str(iterations(9)),num2str(iterations(10)))
axis tight
% figure;plot(squeeze(errorspg(:,:,1)),squeeze(erroramp(1,:,2)))%./squeeze(erroramp(:,:,5)),'-','LineWidth',2);title('AMP')
% ylabel('error');xlabel('maxvec');%legend(num2str(matrixvectors(1)),num2str(matrixvectors(2)),num2str(matrixvectors(3)))%,num2str(iterations(4)),num2str(iterations(5)),num2str(iterations(6)),num2str(iterations(7)),num2str(iterations(8)),num2str(iterations(9)),num2str(iterations(10)))
% axis tight

% %%
% figure;plot(squeeze(errorspg(1,:,1)),squeeze(errorspg(1,:,6)))%./squeeze(errorspg(:,:,5)),'-','LineWidth',2);title('SPGl1')
% xlabel('N');ylabel('iter');%legend(num2str(matrixvectors(1)),num2str(matrixvectors(2)),num2str(matrixvectors(3)))%,num2str(iterations(4)),num2str(iterations(5)),num2str(iterations(6)),num2str(iterations(7)),num2str(iterations(8)),num2str(iterations(9)),num2str(iterations(10)))
% axis tight
% figure;plot(squeeze(errorpqn(1,:,1)),squeeze(errorpqn(1,:,6)))%./squeeze(errorpqn(:,:,5)),'-','LineWidth',2);title('pqnl1')
% xlabel('N');ylabel('iter');%legend(num2str(matrixvectors(1)),num2str(matrixvectors(2)),num2str(matrixvectors(3)))%,num2str(iterations(4)),num2str(iterations(5)),num2str(iterations(6)),num2str(iterations(7)),num2str(iterations(8)),num2str(iterations(9)),num2str(iterations(10)))
% axis tight
% figure;plot(squeeze(errorspg(1,:,1)),squeeze(erroramp(1,:,6)))%./squeeze(erroramp(:,:,5)),'-','LineWidth',2);title('AMP')
% xlabel('N');ylabel('iter');%legend(num2str(matrixvectors(1)),num2str(matrixvectors(2)),num2str(matrixvectors(3)))%,num2str(iterations(4)),num2str(iterations(5)),num2str(iterations(6)),num2str(iterations(7)),num2str(iterations(8)),num2str(iterations(9)),num2str(iterations(10)))
% axis tight
% 
